<body>
  <!-- Sidenav -->
  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-#288FDD" id="sidenav-main" style="background-color:#288FDD;">
...
/* ]]> */
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="deposit.php">
                ...
                <span class="nav-link-text text-white">Deposit</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="invest.php">
                <i class="ni ni-money-coins text-danger"></i>
                <span class="nav-link-text text-white">Invest</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="earnings.php">
                <i class="ni ni-credit-card text-danger"></i>
                <span class="nav-link-text text-white">Earnings</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="withdraw.php">
                <i class="ni ni-credit-card text-danger"></i>
                <span class="nav-link-text text-white">Withdrawal</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="myorder.php">
                <i class="ni ni-cart text-danger"></i>
                <span class="nav-link-text text-white">Deposit Orders</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="incomeforecast.php">
                <i class="ni ni-building text-danger"></i>
                <span class="nav-link-text text-white">Income Forecast</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="referral.php">
                <i class="ni ni-building text-danger"></i>
                <span class="nav-link-text text-white">Referral</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
  ...
  <div class="main-content" id="panel">
    <!-- Topnav -->
    <nav class="navbar navbar-top navbar-expand border-bottom" style="background-color:#273282">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  text-white font-weight-bold"><?php echo $userfirstname;?></span>
                  </div>
                </div>
              </a>
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="kyc.php" class="dropdown-item">
                  <i class="ni ni-single-02"></i>
